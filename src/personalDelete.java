...
public class personalDelete extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7369067336813053167L;
	 ...
	 * Create the frame.
	 */
	public personalDelete(final Acquaintances contactList) {
		setResizable(false);
		...
		final JTable personalTable = new JTable();
		...
		scrollPane.setBounds(12, 0, 754, 406);
		contentPane.add(scrollPane);
		
		JButton btnDeleteContact = new JButton("Delete Contact");
		btnDeleteContact.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				int index = personalTable.getSelectedRow();
				contactList.personalFriendsList.remove(index);
				try
			      {
				...
				JOptionPane.showMessageDialog(null, "One Personal Friend Successfully Deleted");
				setVisible(false);
			}
		});
		btnDeleteContact.setBounds(197, 435, 163, 25);
		try {
		...
		btnBack.setBounds(486, 435, 156, 25);
		try {
